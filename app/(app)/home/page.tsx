    ...
    <section className="flex flex-col gap-2">
      <div className="container">
        <Image
          ...
          width={500}
          alt="profile photo"
          className="object-cover rounded-md max-h-60"
        />
      </div>

      <div className=" flex flex-col gap-5  w-full  container">
      ...
      <div className="w-full bg-gray-800 h-full pb-10 container flex flex-col gap-5">
